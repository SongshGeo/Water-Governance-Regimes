...
A comparison of the phases under different dimensions reveals notable differences between each water use regime 
(Figure~\ref{fig:dimensions}).
\begin{figure*}%[htbp]
	\centering
...
\subsection*{Drivers of regime shifts}
Based on our model, two regime shifts had distinct main drivers.
% 第一个 regime shift 主要是经济总量提升导致资源耗竭的加速。
%经济总量对用水量预测的能力，经济总量对水资源压力的预测能力。
%经济总量+水库修建对水量、水资源压力的预测
% 第二次 regime shift 发生了用水关系的变化
