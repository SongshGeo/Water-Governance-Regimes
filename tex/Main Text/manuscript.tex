...
whose regimes have clear phase-characteristics with gradual transitions between different phases (Figure~\ref{fig:phases}).

\begin{figure}%[htbp]
	\centering
	\includegraphics[width=\linewidth]{../../figures/main_text/phases.pdf}
	\caption{Combination of three dimensions of water utilization regimes in three different periods. 
