...
\begin{figure}[th!]
	...
	\caption{
		...
		\textbf{A.} Changes in total irrigated area (orange line), and water consumptions per unit of area (green dot line, see \textit{SI Appendix} Methods S2).
		\textbf{B.} Changes in gross values added (GVA) of industry and services (blue line), and their water use intensity for unit production (WUI, red dot line) respectively (\textit{SI Appendix} Methods S2).
