...
\label{significance}
	...
	Three water governance regimes are identified (massive supply, purpose-focused, and many-sided governance).
...
% 通讯作者信息
\correspondingauthor{\textsuperscript{1}To whom correspondence should be addressed. E-mail: fubj@bnu.edu.cn}
...
\begin{abstract}
	...
	Our application of the IWGI suggests a widespread transition schema for water governance regimes and a general transformative trajectory as a hypothesis for understanding hydrosocial water cycles in the Anthropocene. 
