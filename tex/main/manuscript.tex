...
\label{significance}
	...
	Therefore, as natural water cycle has been dominated by growing socio-economic processes towards a hydro-social water cycle, big river basins are roundly governed stage by stage for further water use. 
	...
	Three water governance regimes are identified (massive supply regime, purpose turned regime, all-sided governance regime) and a widespread regime-transition schema can be summarized after then. 
...
\begin{abstract}
	...
	Here, combining three main dimensions (supply, purpose and allocation), we develop an Integrated Water Governance Index (IWGI) at a basin scale to detect regime shifts of water governance.
	...
	Based on that, we summarize a widespread transition schema of water governance regime, paralleled with a transformative trajectory towards hydro-social water cycle in the Anthropocene.
