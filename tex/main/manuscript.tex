...
tendentiousness (Figure~\ref{fig:dimensions}B and Figure~\ref{fig:dimensions}E) and patterns (Figure~\ref{fig:dimensions}C and Figure~\ref{fig:dimensions}F) of water utilization were enlarging their impacts. 
% 首先是用水比例的变化
