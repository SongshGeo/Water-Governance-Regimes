...
Entering the transformation governance regime (P2), however, the expansion of irrigated area slowed down, and industry and services gradually took off, with more water demands (Figure\ref{fig:Causes} A and B), leading to an $8\%$ reduction in the proportion of irrigation water use (\textit{SI Appendix} S3).
