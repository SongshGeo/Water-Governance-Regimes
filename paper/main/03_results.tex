...
% Overall
Taken together, the overall features of the three dimensions in different periods is relative to a directional change in the combination of three dimensions (Figure~\ref{fig:IWGI}C).
...
As the dominant water demand during the massive supply regime (P1), the area of irrigated agriculture in the YRB expanded rapidly at a rate of $0.25*10^6 ha/yr$ (Figure\ref{fig:Causes} A), simultaneously supported by increasing supply through the constructions of reservoirs (\textit{SI Appendix} Fig. S3).
