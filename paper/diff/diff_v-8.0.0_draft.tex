...
\DIFdel{.
First, water stress depends not only on climate (with increasing scarcity and uncertainty in many regions) but also on the increasingly insatiable }\DIFdelend \DIFaddbegin \DIFadd{~}\cite{mariajacobson2013}\DIFadd{.huggins2022a
...
\DIFdelend \DIFaddbegin \DIFadd{Multiple sources of data were used in this study, and we have attached a summarized data table as Supporting Information and their processing are detailed described in the supplementary documentation}\DIFaddend .
