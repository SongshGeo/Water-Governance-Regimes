...
\begin{figure}[!htb]
    ...
    \caption{
        \textbf{left} Changing trend of the indicator of purpose (IP)
        \textbf{right} contributions of different water use sectors to the IS's changes.
    }\label{fig:purpose}
\end{figure}
...
\begin{figure}[!htb]
    ...
    \caption{Changing trend of the indicator of allocation (IA)}\label{fig:allocation}
\end{figure}
