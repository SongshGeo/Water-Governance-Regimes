...
\begin{enumerate}
\item Text S1 to S3
\item Figures S1 to Figure~\ref{fig:conveyance}
...
\noindent\textbf{Trend of Indicators}\label{secA2}
\input{02_indicator.tex}

\noindent\textbf{Correlation of Indicators}\label{secA3}
\input{03_correlation.tex}

\noindent\textbf{Robustness}\label{secA4}
\input{04_robustness.tex}
