...
Then, the indicators corresponding to the IWGI are introduced in the section Methods S4.
...
\begin{itemize}
    %! Why ??? Explaination: why should development lead to balance among regions or meet the needs of different sectors.
...
% 无论我们使用上述哪种标准化方法，将三个维度的指标合成为IWGI，我们对IWGI的断点检测结果都相同。
...
% \begin{figure}
% 	\centering
% 	\includegraphics[width=\linewidth]{../../figures/main/aspects.pdf}
% 	\caption{
% 		Changes in different aspects of water resources utilization regimes and their main contributors.
...
% 		\textbf{B,} changes of water utilization purpose, indicated by non-provisioning water shares (see \textit{SI Appendix} Methods S4).
...
% 		\textbf{E,} Main impact water uses to water utilization purpose, and their change contributions to non-provisioning water shares.
