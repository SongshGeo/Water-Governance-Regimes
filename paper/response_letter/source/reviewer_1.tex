...
\begin{quote}[page=11, sline=320, eline=323]
	% 以黄河流域所面临的挑战为例，国家叙事从经济征服自然、消除污染到强调人水和谐的转变，增加了行政措施在解决与水有关的纠纷中的重要性。
...
\begin{quote}[page=11, sline=323, eline=326]
	% 它再次表明，高度控制和开发的流域(特别是跨界河流)必须解决结构性挑战，例如水争端或缺乏公平，并且可能迫切需要新的灵活、有效的社会政治治理结构。
