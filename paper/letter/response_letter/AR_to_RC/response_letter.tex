...
% 再方法中补充了指标的取值范围（三个子指标的变化范围都是0～1）。
\AR{} Thanks for point it out! Now

\AR*{} Figure SX to SX are three indicators changing trends with different regions' contribution.

\AR*{} Ranges of three indicators and meaning of their values are further explained in the methodology section, now:
